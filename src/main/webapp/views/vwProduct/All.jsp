...
<t:main>
    <jsp:body>
        ...
        <div class="content row grid wide">
            ...
            <div class="row content_products" style="margin-top: 100px">
                <a href="#" id="content_ao">
                    <div class="row content_title" >Áo thun</div>
                </a>
                <div class="row content_pants">
            ...
            <div class="row content_products" style="margin-top: 100px">
                <a href="#" id="content_aokhoac">
                    <div class="row content_title" >Áo khoác:</div>
                </a>
                <div class="row content_pants">
            ...
            <div class="row content_products" style="margin-top: 100px">
                <a href="#" id="content_balo">
                    <div class="row content_title" >Ba lô:</div>
                </a>
                <div class="row content_pants">
            ...
            <div class="row content_products" style="margin-top: 100px">
                <a href="#" id="content_quandui">
                    <div class="row content_title" >Quần đùi:</div>
                </a>
                <div class="row content_pants">
